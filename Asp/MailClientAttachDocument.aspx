<%@ Page Language="VB" AutoEventWireup="false" Inherits="EngageWebLibrary.clsMailClientAttachDocument" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../Js/MailClientAttachDocument.js"></script>
...
<body style="background-color: #ffffff">
    <form id="frmMailClientAttachment" runat="server">
    <asp:ScriptManager ID="smMailClientAttachment" runat="server" />
    <telerik:RadWindowManager ID="MailClientAttachDocumentAlerts" runat="server"></telerik:RadWindowManager>
    <script type="text/javascript" language="javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
    </script>
    <telerik:RadProgressManager id="prgmgrUpload" runat="server" 
        SkinID="MailClientAttachDocuments" EnableViewState="False" 
    ...
    <div id="divUploadData" class="FilterMenu" style="height: 90px; width: 510px; margin-top:15px;">
        <div class="busquedaclass" align="left" style="padding-left: 20px">
            <div class="FilterElement" style="height:20px;">
                ...
                <telerik:RadUpload ID="rduMailClientAttach" runat="server" MaxFileInputsCount="1" style="float:left;"
            ...
            <div class="FilterElement">
                ...
                <a id="lnkAdd" style="width: 70px; text-align: center;" class="ovalbutton" href="javascript:MailClientAttachmentValidation();"><span>Agregar</span></a>
    ...
    <div id="divUploadProgress" style="display: none; width: 510px; height: 100%; margin-left: 20px; margin-top:30px; margin-bottom: 20px; text-align: center;">
        <div style="width: 100%; display: block;">
            <telerik:RadProgressArea id="prgareaUpload" runat="server"
                SkinID="MailClientAttachDocuments" DisplayCancelButton="True" 
