<%@ Page Language="VB" AutoEventWireup="false" Inherits="EngageWebLibrary.clsAttachDocuments" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="../js/AttachDocuments.js"></script>
...
<body style="height: 100%; margin: 0px; background-color: #ffffff" onload="OnLoad();">
    ...
    <div style="width: 100%; height: 100%;">
        <asp:ScriptManager ID="smAttachments" runat="server" />
        <telerik:RadWindowManager ID="AttachDocumentsAlerts" runat="server">
            <windows>
                <telerik:RadWindow ID="wndAttach" Runat="server" 
        ...
        <telerik:RadToolBar ID="tbAttachments" Runat="server" style="display: none;" />
        <script type="text/javascript" language="javascript">
            Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
        </script>
        <telerik:RadAjaxManager runat="server" ID="ramAttachments">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="grdAttachments">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdAttachments" LoadingPanelID="ralpAttachments" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <telerik:RadAjaxLoadingPanel ID="ralpAttachments" Transparency="20" BackColor="#E0E0E0" runat="server" EnableTheming="false" EnableViewState="false">
            <div class="LoadingImage"></div>
        </telerik:RadAjaxLoadingPanel>   
        <asp:ObjectDataSource ID="odsAttachments" runat="server" SelectMethod="GetAttachments"
            ...
            <tr>
                <td align="left" style="width: 100%">
                                    ...
                                    <div class="rtbInner">
                                        <ul class="rtbUL">
                                            <li class="rtbItem">
                                                ...
                                                <a id="lnkView" class="ovalbutton" runat="server" href="javascript:OpenAttachment();">
                                                    <span>Ver</span>
                                                </a>
                                                <a id="lnkSave" class="ovalbutton" runat="server" href="javascript:SaveAttachment();">
                                                    <span>Guardar</span>
                                                </a>
                                                <a id="lnkDelete" class="ovalbutton" runat="server" href="javascript:DeleteAttachment();">
                                                    <span>Eliminar</span>
                                                </a>
                    ...
                    <div id="divUploadedFiles" class="GridContainer">
                        <telerik:RadGrid ID="grdAttachments" DataSourceID="odsAttachments" runat="server" AllowPaging="True" 
                            SkinID="AttachDocuments" CellPadding="4" EnableEmbeddedSkins="False" GridLines="Vertical"
                            ...
                            <MasterTableView DataSourceID="odsAttachments" AutoGenerateColumns="False" EnableViewState="True" 
