...
var gsOutOfRange="Lo siento, el rango establecido no se encuentra disponible.";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"No puede seleccionar el dia de hoy!\");return false;' onmouseover='return true;' >Hoy : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
var gsBottomClear=(NN4?"":"<DIV class='BottomDiv'>")+"<A href='javascript:void(0)' class='BottomAnchor'  onclick='if(this.blur)this.blur();fClearSelected();fHideCal();return false;' onmouseover='return true;'>Borrar</A>"+(NN4?"":"</DIV>");
