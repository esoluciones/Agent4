...
function MailClientAttachmentValidation() {
    var upload = $find('rduMailClientAttach');
    ...
    if (input[0].value == "") {
        ...
        if (txtdesc == '') {
            ...
            document.frmMailClientAttachment.submit();
        }            
    }
}
...
function Exit() {
    ...
    var wnd = target.$find('wndMailClientAttach');
    wnd.close();
}